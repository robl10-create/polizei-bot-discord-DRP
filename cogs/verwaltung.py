...
class WeeklyInsiderSetupView(discord.ui.View):
    def __init__(self, creator: discord.Member, verwaltung_cog):
        super().__init__(timeout=600)
        self.creator = creator
        self.verwaltung_cog = verwaltung_cog
    ...
    async def post_now(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        lc = self.verwaltung_cog.get_listen_cog()
...
class VerwaltungCog(commands.Cog):
...
async def setup(bot):
    await bot.add_cog(VerwaltungCog(bot))